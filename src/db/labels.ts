...
export async function getAllLabels(db: SQLite.SQLiteDatabase): Promise<Label[]> {
...
export async function deleteLabel(db: SQLite.SQLiteDatabase, id: string): Promise<void> {
